<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{utype: 'USR'}">
            @csrf
            ...
            <div class="mt-4">
                <x-jet-label for="utype">Registered as:</x-jet-label>
                <select id="utype" name="utype" x-model="utype" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
