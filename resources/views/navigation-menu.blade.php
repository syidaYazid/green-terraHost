    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ url('/shop') }}" :active="request()->routeIs('/shop')">
                        {{ __('Shop') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ url('/cart') }}" :active="request()->routeIs('/cart')">
                        {{ __('Cart') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ url('/checkout') }}" :active="request()->routeIs('/checkout')">
                        {{ __('Checkout') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ url('/transaction') }}" :active="request()->routeIs('/transaction')">
                        {{ __('Transaction') }}
                    </x-jet-nav-link>
                </div>
                @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('plants.index') }}" :active="request()->routeIs('plants.index')">
                        {{ __('Plants') }}
                    </x-jet-nav-link>
                </div>
                @endif
